...
| Entrega 4 | Arquitetura e padrões | [`docs/06_arquitetura_e_projeto.md`](https://github.com/GradeUFLA/.github/blob/main/docs/06_arquitetura_e_projeto.md) e `docs/07_padroes_de_projeto.md` |
