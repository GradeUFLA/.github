...
└── .github
    ...
    │   ├── 09_testes.md
    │   ├── 10_entregas_incrementais.md
    │   └── 11_apresentacao_final.md
    ├── sprints
    │   ├── sprint_01.md
    │   ├── sprint_02.md
    │   ├── sprint_03.md
...
| Entrega 3 | Modelagem e decisões de projeto | [`docs/05_modelagem.md`](https://github.com/GradeUFLA/.github/blob/main/docs/05_modelagem.md) |
| Entrega 4 | Arquitetura e projeto | [`docs/06_arquitetura_e_projeto.md`](https://github.com/GradeUFLA/.github/blob/main/docs/06_arquitetura_e_projeto.md)  |
| Entrega 5 | Padrões de projeto | [`docs/07_padroes_de_projeto.md`](https://github.com/GradeUFLA/.github/blob/main/docs/07_padroes_de_projeto.md) |
| Entrega 6 | Arquitetura do sistema | [`docs/08_arquitetura do sistema.md`](https://github.com/GradeUFLA/.github/blob/main/docs/08_arquitetura_do_sistema.md) |
| Entrega 7 | Estratégia de testes e evidências | [`docs/09_testes.md`](https://github.com/GradeUFLA/.github/blob/main/docs/09_testes.md) |
| Entrega final | Consolidação e apresentação | [`docs/10_entregas_incrementais.md`](https://github.com/GradeUFLA/.github/blob/main/docs/10_entregas_incrementais.md) e [`docs/11_apresentacao_final.md`](https://github.com/GradeUFLA/.github/blob/main/docs/11_apresentacao_final.md) |
