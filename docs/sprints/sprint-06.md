...
Realizar a entrega final do sistema **gradeUFLA**. O foco desta sprint é finalizar todas as integrações pendentes entre o Front-end e o Back-end, aplicar a nova arquitetura de importação de dados via `.zip` (substituindo o acionamento direto do bot), garantir a responsividade mobile das telas públicas, executar o deploy da aplicação e compilar toda a documentação de encerramento (relatórios, apresentação e vídeo final).

## 3. Itens do Sprint Backlog

| Demanda (Task) | Responsável | Área (Labels) | Situação |
| :--- | :--- | :---: | :--- |
| [US03] Tela de Conclusão de Matérias - Aluno #10 | JoseVitorMachado | História de Usuário | Concluído |
| [US04] Tela de Montagem da Grade - Aluno #11 | JoseVitorMachado | História de Usuário | Concluído |
| [US06] Login de Usuário - Administrador #13 | JoseVitorMachado | História de Usuário | Concluído |
| [US07] Tela de Dashboard - Administrador #14 | JoseVitorMachado | História de Usuário | Concluído  |
