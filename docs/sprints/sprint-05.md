...
| Back-end: Tela de analytics - admin #46 | Fernando | Back-End | Concluído |
| Back-end: Tela de dados - admin #49 | Fernando | Back-End | Concluído |
| Exportar a grade em .jpg #51 | Jhennifer | Front-End | A fazer |
| Desenvolver uma PoC em Python para extrair dados... #64 | Bárbara | scraping-bot | Concluído |
| Banco de dados: Validar relação entre tabelas disciplina e matriz... #65 | Bárbara | Banco de Dados | Concluído |
| Integração: tela de login #66 | Jhennifer | Front-End | A fazer |
| Integração: Stepper e tela de matérias concluídas #67 | Jhennifer | Front-End | Concluído |
| Integração: tela montagem de grade #68 | Jhennifer | Front-End | Em andamento |
| Banco de dados: Validar as consultas (queries) para otimização... #69 | Bárbara | Banco de Dados | concluído |
| Banco de dados: Escrever consultas otimizadas nas tabelas... #70 | Bárbara | Banco de Dados | Concluído |
...
| Extração de pré-requisitos #81 | Bárbara | scraping-bot | Concluído |
| Extração de turmas #82 | Bárbara | scraping-bot | concluído |
| Extração de horários #83 | Bárbara | scraping-bot | Concluído |
| Back-end: Criar endpoint que aciona o script Python... #85 | Fernando | Back-End | Cancelado |
...
| Responsividade para telas mobile - Telas públicas #93 | Clara | Design | A fazer |
...
- **O que foi concluído:** Todas as tarefas de extração essenciais que estavam "Em testes" foram validadas com sucesso (cursos, disciplinas e matrizes). O Back-end entregou as rotas de exportação e as bases das telas administrativas.
...
- **[Design]** Modificar o protótipo da tela de Dados (Admin), substituindo o botão de "Rodar Bot" por um componente de Upload de arquivo `.zip`.
...
- **[Front-end]** Implementar a lógica para exportação da grade no google agenda.
- **[Documentação]** Atualizar os diagramas de arquitetura para o desacoplamento do bot
- **[Documentação]** Atualizar toda a documentação para o novo modelo de tratamento do bot.
...
Feita em sala de aula, não possui registros.
