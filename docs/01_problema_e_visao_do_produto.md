## 1. Identificação do problema escolhido
...
- Para o usuário final: Permite visualizar grades horárias, montar horários de disciplinas obrigatórias e eletivas e, por fim, exportar os resultados de forma totalmente gratuita, seja por imagem ou sincronizando com o aplicativo do google agenda.
