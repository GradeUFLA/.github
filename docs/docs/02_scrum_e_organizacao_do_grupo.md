### 1. Organização inicial do projeto em formato ágil
...
Organização das Tarefas: Serão utilizadas Issues separadas por funcionalidade, Labels para indicar prioridades, equipes e Milestones para agrupar as entregas de cada sprint.
